...
const Testionails = () => {
    return (
        <section className="text-gray-600 body-font bg-gray-900">
            <div className="container mx-auto flex flex-col px-5 sm:px-20 py-14">
                <div className='max-w-sm text-center space-y-5 text-white m-auto mb-16'>
                    <h1 className='text-4xl font-noto font-bold'>Testimonials</h1>
                    <p className='text-sm'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 -m-4">
                    <div className="p-4 w-full">
                        <div className="h-full bg-gray-800 p-8 rounded text-white">
